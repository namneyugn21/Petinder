    ...
    return (
        <div className='safety' id='safety'>
            <div className='safety__container'>
                <motion.h1 
                    className='safety__title montserrat-bold'
                    initial={{ opacity: 0 }}
                ...
                <div className='safety__content'>
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 0.6 }}>
                            <h2 className='safety__content__item-title montserrat-semibold'>Online Safety</h2>
                            <ul className='montserrat-regular'>
                    ...
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 0.6 }}>
                            <h2 className='safety__content__item-title montserrat-semibold'>Meeting Pets at Shelters</h2>
                            <ul className='montserrat-regular'>
                    ...
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 0.6 }}>
                            <h2 className='safety__content__item-title montserrat-semibold'>Safety and Well-being</h2>
                            <ul className='montserrat-regular'>
                    ...
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 0.6 }}>
                            <h2 className='safety__content__item-title montserrat-semibold'>Help & Support</h2>
                            <ul className='montserrat-regular'>
